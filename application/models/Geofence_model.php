...
class Geofence_model extends CI_Model
{
	...
	{
		$insertdata = array('geo_name' => $data['geo_name'], 'geo_description' => $data['geo_description'], 'geo_area' => $data['geo_area'], 'geo_lat' => $data['geo_lat'], 'geo_lng' => $data['geo_lng'], 'geo_radius' => $data['radius'], 'geo_vehicles' => implode(',', $data['geo_vehicles']));
