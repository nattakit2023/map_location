                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php } ?>
                                                <a style="color: red;" href="#" onclick="deleteShipCertificate(<?= $fms_data['id'] ?>)"><i class="fas fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        </tr>
                                <?php }
...
<script>
    ...
    function deleteShipCertificate(ship_cer_id) {
        if (confirm('Are you sure you want to delete this Ship Certificate report?')) {
            $.ajax({
                url: '<?= base_url(); ?>reports/delete_ship_cer',
                type: 'POST',
                data: {
                    id: ship_cer_id
                },
