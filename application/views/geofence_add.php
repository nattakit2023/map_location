...
<div class="card-header">
  ...
  <div class="row">
    <div class="col-sm-8 col-md-6">
      <h3 class="card-title">
        <div class="form-group row">
          <label for="geo_description" class="col-sm-5 col-md-2 col-form-label">Input Address </label>
    ...
    <div class="form-group col-sm-4 col-md-1" id="savemarker" hidden>
      <button class="btn btn-block btn-outline-success btn-sm">Save Geofence</button>
    </div>
...
<script>
  ...
  function addmarker(lat, lng, radiusNMI) {
    ...
    const marker = L.marker([lat, lng], {}).addTo(map); // Use custom icon
