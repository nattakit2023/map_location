          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-sm-6 col-md-4">
                ...
                <div class="form-group">
                  <input type="text" name="v_name" id="v_name" class="form-control" placeholder="Vessel Name" value="<?php echo (isset($vehicledetails)) ? $vehicledetails[0]['v_name'] : '' ?>">
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  ...
                  <input type="text" name="v_chassis_no" value="<?php echo (isset($vehicledetails)) ? $vehicledetails[0]['v_chassis_no'] : '' ?>" class="form-control" placeholder="MMSI">
                </div>
              </div>
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  ...
                  <select id="v_type" name="v_type" class="form-control " required="">
                    ...
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'CAR') ? 'selected' : '' ?> value="CAR">Supply Boat</option>
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'MOTORCYCLE') ? 'selected' : '' ?> value="MOTORCYCLE">Crew Boat</option>
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'TRUCK') ? 'selected' : '' ?> value="TRUCK">Support</option>
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'BUS') ? 'selected' : '' ?> value="BUS">Anchor Handling Tug Supply </option>
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'TAXI') ? 'selected' : '' ?> value="TAXI">Dive Support</option>
                    <option <?php echo (isset($vehicledetails) && $vehicledetails[0]['v_type'] == 'BICYCLE') ? 'selected' : '' ?> value="BICYCLE">Accommodation</option>
                  </select>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  <label for="v_color" class="form-label">Vessel Color<small> (To show in Map)</small></label>
              ...
              <?php if (isset($vehicledetails[0]['v_is_active'])) { ?>
                <div class="col-sm-6 col-md-4">
                  <div class="form-group">
                    <label for="v_is_active" class="form-label">Vessel Status</label>
              ...
              <div class="col-sm-6 col-md-4">
                <div class="form-group">
                  <label for="v_group" class="form-label">Vessel Group</label>
                  <select id="v_group" name="v_group" class="form-control " required="">
                    <option value="">Select Vessel Group</option>
