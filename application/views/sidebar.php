   ...
   <div class="sidebar">
      <nav class="mt-2">
         <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview <?php echo ((activate_menu('fms')) == 'active') ? 'menu-open' : '' ?> <?php echo ((activate_menu('crew_status')) == 'active') ? 'menu-open' : '' ?> <?php echo ((activate_menu('ship_cer')) == 'active') ? 'menu-open' : '' ?> <?php echo ((activate_menu('pms')) == 'active') ? 'menu-open' : '' ?> <?php echo ((activate_menu('safety')) == 'active') ? 'menu-open' : '' ?>">
               ...
               <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>reports/pms" class="nav-link <?php echo activate_menu('pms'); ?>">
                        <i class="fas fa-cosg icon nav-icon"></i>
                        <p>PMS</p>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>reports/safety" class="nav-link <?php echo activate_menu('safety'); ?>">
                        <i class="fas fa-cosg icon nav-icon"></i>
                        <p>Safety</p>
                     </a>
                  </li>
                  <li class="nav-item">
                     <a href="<?= base_url(); ?>reports/ship_cer" class="nav-link <?php echo activate_menu('ship_cer'); ?>">
                        <i class="fas fa-cosg icon nav-icon"></i>
